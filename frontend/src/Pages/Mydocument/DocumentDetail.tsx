        ...
        if (ocrId) {
            ...
            fetchWithAuth(`/ocr/posts/${ocrId}`)
                .then((res) => {
                    ...
                    console.log(documentData?.originalImg.split('\\').pop());
                })
                .catch((error) => {
            ...
            {documentData?.originalImg ? (
                <div className='flex flex-row items-center justify-between mt-4'>
                    <div>
                        ...
                        <img src={documentData?.originalImg.split('\\').pop()} alt="원본 이미지" className='w-[620px] h-[877px] border-2 border-gray-300'/>
                    </div>
